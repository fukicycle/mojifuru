...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    version: '0.9.15',
    items: [
      '「ずかん」を追加。これまでに作ったことばがたまっていきます(タイトル画面から見られます)',
      'けっか画面に「はじめて見つけた ことば」が出るようになりました',
      '濁点・半濁点の入ったことば(レア)ができたとき、専用の演出と音が出るようになりました',
      'ずかんはアカウントに記録されるので、Googleでつづければ ほかの端末でも同じずかんが見られます',
    ],
  },
  {
    version: '0.9.16',
    items: [
      'ひとりで遊んだあとのけっか画面を見やすくしました。作ったことばの一覧が、ほとんど全部そのまま見えます',
      '「はじめて見つけた ことば」は一覧の✨マークにまとめ、同じことばが二か所に並ばないようにしました',
      'ことばの一覧を、せんせきと同じ丸いチップの見た目にそろえました',
    ],
  },
];
